            ...
            for (int j = 0; j < SIM_MAP_HAUTEUR; j++) {
                ...
                switch (matrice[i][j]) {
                    ...
                    case 'T':{
                        ...
                        habitation->position = (Vector2I) {i, j};

                        for (int u = 0; u < 3; ++u) {
                            for (int g = 0; g < 3; ++g) {
                                gameplayScreen->world->map[i + u][j + g].type = KIND_HABITATION;
                                gameplayScreen->world->map[i + u][j + g].donnees = habitation;
                            }
                        }

                        liste_ajout_tri(gameplayScreen->world->habitations, habitation, habitation_tri_par_distance);
                        break;
                    }

                    case 'Y':{
                        Habitation_t* habitation = habitation_alloc(NIVEAU_RUINE);
                        habitation->position = (Vector2I) {i, j};
                    ...
                    case 'C':{
                        Habitation_t* habitation = habitation_alloc(NIVEAU_CABANE);
                        habitation->position = (Vector2I) {i, j};
                    ...
                    case 'M':{
                        Habitation_t* habitation = habitation_alloc(NIVEAU_MAISON);
                        habitation->position = (Vector2I) {i, j};
                    ...
                    case 'I':{
                        Habitation_t* habitation = habitation_alloc(NIVEAU_IMMEUBLE);
                        habitation->position = (Vector2I) {i, j};
                    ...
                    case 'S':{
                        Habitation_t* habitation = habitation_alloc(NIVEAU_GRATTE_CIEL);
                        habitation->position = (Vector2I) {i, j};
                    ...
                    case 'Z':{
                        ...
                        centrale->position = (Vector2I) {i, j};


                        for (int u = 0; u < 6; ++u) {
                            for (int g = 0; g < 4; ++g) {
                                gameplayScreen->world->map[i + u][j + g].type = KIND_CENTRALE;
                                gameplayScreen->world->map[i + u][j + g].donnees = centrale;
                            }
                        }

                        liste_ajouter_fin(gameplayScreen->world->centrales, centrale);
                        break;
                    }
                    case 'E':{
                        ChateauEau_t* chateau = chateau_alloc();
                        chateau->position = (Vector2I) {i, j};


                        for (int u = 0; u < 6; ++u) {
                            for (int g = 0; g < 4; ++g) {
                                gameplayScreen->world->map[i + u][j + g].type = KIND_CHATEAU;
                                gameplayScreen->world->map[i + u][j + g].donnees = chateau;
                            }
                        }
